...
export class BundleManager {
    ...
    public static loadAsset<T extends typeof Asset,
        ...
        TAssetName = keyof BundleConfig['BundleName'][TBundleName]['prefab'] | keyof BundleConfig['BundleName'][TBundleName]['sound'] | keyof BundleConfig['BundleName'][TBundleName]['texture'] | string>
        (bundleName: TBundleName | string, assetName: NoInfer<TAssetName>, assetType: T): Promise<InstanceType<T>> {
        // let str = this.getAssetUrl(assetType);
        // @ts-ignore
        let url: string = assetName;
        ...
        return new Promise(async (resolve, reject) => {
            // @ts-ignore
            ResMgr.load(bundleName, url, (err: Error, res: any) => {
                if (!err) {
                    // 加载成功
                    resolve(res);
                }
     ...
     * @param assetName 资源名
     */
    public static loadPrefab<TBundleName extends BundleName, TAssetName = keyof BundleConfig['BundleName'][TBundleName]['prefab'] | string>
        (bundleName: TBundleName | string, assetName: NoInfer<TAssetName>): Promise<Prefab> {
     ...
     * @param assetName 资源名
     */
    public static loadAudio<TBundleName extends BundleName, TAssetName = keyof BundleConfig['BundleName'][TBundleName]['sound'] | string>
        (bundleName: TBundleName | string, assetName: NoInfer<TAssetName>): Promise<AudioClip> {
     ...
     * @param assetName 资源名
     */
    public static loadTextre<TBundleName extends BundleName, TAssetName = keyof BundleConfig['BundleName'][TBundleName]['texture'] | string>
        (bundleName: TBundleName | string, assetName: NoInfer<TAssetName>): Promise<SpriteFrame> {
