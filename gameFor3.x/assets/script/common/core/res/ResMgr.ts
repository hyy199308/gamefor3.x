...
type IRemoteOptions = __private._cocos_core_asset_manager_shared__IRemoteOptions;
...
export class ResMgrCls {

    /** 单例 */
    private constructor() { }
    /** 实例 */
    static readonly ins = new ResMgrCls();
     ...
     * @param onComplete    加载完成回调
     * @example
    ResMgr.load("spine_path", sp.SkeletonData, (err: Error | null, sd: sp.SkeletonData) => {
     ...
     * @param type          资源类型
     * @example
    ResMgr.preloadDir("game", onProgressCallback, onCompleteCallback);
    */
    preloadDir<T extends Asset>(bundleName: string, dir: string, type: AssetType<T> | null): void;
    preloadDir<T extends Asset>(bundleName: string, dir: string, type: AssetType<T> | null, onProgress: ProgressCallback | null, onComplete: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(bundleName: string, dir: string, onProgress: ProgressCallback | null, onComplete: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(bundleName: string, dir: string, onComplete?: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(bundleName: string, dir: string, type: AssetType<T> | null, onComplete?: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(dir: string, type: AssetType<T> | null, onProgress: ProgressCallback | null, onComplete: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(dir: string, onProgress: ProgressCallback | null, onComplete: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(dir: string, onComplete?: CompleteCallback<T[]> | null): void;
    preloadDir<T extends Asset>(dir: string, type: AssetType<T> | null, onComplete?: CompleteCallback<T[]> | null): void;
     ...
     * @param bundleName    远程资源包名
     */
    get<T extends Asset>(path: string, type?: __private._cocos_core_asset_manager_shared__AssetType<T> | null, bundleName: string = "resources"): T | null {
        var bundle: AssetManager.Bundle | null = assetManager.getBundle(bundleName);
...
export const ResMgr = ResMgrCls.ins;